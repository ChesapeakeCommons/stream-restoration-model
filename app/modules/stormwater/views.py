...
@module.route('/v1/data/summary/stormwater/<int:practice_id>', methods=['OPTIONS'])
def summary_stormwater_options(practice_id):
...
@module.route('/v1/data/summary/stormwater/<int:practice_id>', methods=['GET'])
@oauth.require_oauth()
def summary_stormwater_get(oauth_request, practice_id):
